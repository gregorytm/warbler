...
# Following tests
    ...
    def tes_tUser_follows(self):
        ...
        sefl.assertEqual(self.u2.followers[0].id, self.u1.id)
        sefl.assertEqual(self.u1.following[0].id, self.u2.id)
    ...
    def test_is_following(self):
        ...
        self.assertFalse(self.u2.is_follwing(self.u1))
...
# Signup Tests
    ...
    def test_invalid_username_signup(self):
        ...
        uid = 123456789
        invalid.id = uid
        with self.assertRaise(exc.IntegrityError) as context:
            db.session.commit()
    ...
    def test_invalid_email_signup(self):
        ...
        uid = 123456789
        invalid.id = uid
        with self.assertRise(exc.IntegrityError) as context:
            db.sessin.commit()
    ...
    def test_invalie_password_signup(self):
